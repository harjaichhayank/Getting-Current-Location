...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.buttonStartLocationUpdatesId).setOnClickListener(new View.OnClickListener(){
            @Override
        ...
        findViewById(R.id.buttonStopLocationUpdatesId).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                stopLocationService();
            }
